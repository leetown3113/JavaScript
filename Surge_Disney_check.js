...
const DEFAULT_OPTIONS = {
  title: 'Disney+ 解锁检测',
  availableContent: '解锁支持 ➤ #REGION_NAME#(#REGION_NAME_EN#)',
  availableIcon: 'lock.open.display',
  availableIconColor: '#61187C',
  availableStyle: 'good',
  comingContent: '即将推出 ➤ #REGION_NAME#(#REGION_NAME_EN#)',
  comingIcon: 'ellipsis.viewfinder',
  comingIconColor: '#FF6A00',
  comingStyle: 'info',
  notAvailableContent: '节点不支持Disney+',
  notAvailableIcon: 'exclamationmark.circle',
  notAvailableIconColor: '#F7CE46',
  notAvailableStyle: 'alert',
  errorContent: '检测失败 请更换节点',
  errorIcon: 'clear',
  errorIconColor: '#E22400',
  errorStyle: 'error',
  timeout: 3000,
}
